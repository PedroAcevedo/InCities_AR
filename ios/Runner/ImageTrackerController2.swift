...
class ImageTrackerViewController2: UIViewController, MTKViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        /*NotificationCenter.default.addObserver(self, selector: #selector(pauseAR), name: UIApplication.NSNotification.Name.UIApplicationWillResignActive, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(enterBackgournd), name: UIApplication.NSNotification.Name.UIApplicationDidEnterBackground, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(resumeAR), name: UIApplication.NSNotification.Name.UIApplicationDidBecomeActive, object: nil)*/
    }
    ...
    func startEngine() {
        MasMaxstAR.setLicenseKey("Vnbli/NSYtYZNkmaZgOGCVyZo/SsufZPmA+cUoGZPFM=")
