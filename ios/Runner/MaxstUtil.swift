...
extension UIColor {
    var rgbaColor: (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat) {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
...
extension UIImage {
    func rotateI(radians: Float) -> UIImage? {
    ...
    static func convertGrayScaleToUIImagen(data:UnsafeRawPointer, width:Int, height:Int) -> UIImage? {
