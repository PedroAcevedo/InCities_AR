...
class MenuPage extends StatelessWidget {
  ...
  Widget _getDocuments(BuildContext context) {
    return FutureBuilder(
      future: menuProvider.loadData(Uri.https('jsonblob.com',
          '/api/jsonBlob/30fa0d50-7eb7-11ea-b97d-87eeec80a901')),
      initialData: [],
      ...
      return Column(
        children: <Widget>[
          ListTile(
            ...
            leading: Icon(Icons.collections, size: 40.0),
            trailing: Icon(
            ...
            onTap: () {
              showSearch(
                  context: context, delegate: SearchDelegatePage(), query: '');
