...
public class RedCubeRenderer extends BaseRenderer {
	...
	private static final float RED_BUF[] = {
			1.0f, 0.0f, 0.0f, 1.0f,
			1.0f, 0.0f, 0.0f, 1.0f,
			1.0f, 0.0f, 0.0f, 1.0f,
			1.0f, 0.0f, 0.0f, 1.0f,
	...
	public RedCubeRenderer() {
		...
		bb = ByteBuffer.allocateDirect(RED_BUF.length * Float.SIZE / 8);
		bb.order(ByteOrder.nativeOrder());
		colorBuffer = bb.asFloatBuffer();
		colorBuffer.put(RED_BUF);
